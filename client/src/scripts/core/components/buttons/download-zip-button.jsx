...
class DownloadZipButton extends React.Component {
    static propTypes = {
    ...
    render() {
        if (this.props.enabled) {
            return (<button
                ...
                onClick={this.clickHandler}><FontAwesomeIcon icon={faFileArchive} /> {this.props.text}</button>)
        }
        else {
            return (<button
                disabled="disabled"
...
export default injectIntl(withRouter(DownloadZipButton))
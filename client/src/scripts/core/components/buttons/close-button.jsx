...
class CloseButton extends React.Component {
    ...
    render() {
        var text = this.props.text || this.props.intl.formatMessage({ id: 'close' });
        ...
        if (this.props.enabled) {
            return (<button
                ...
                onClick={this.clickHandler}><FontAwesomeIcon icon={faTimes} /> {text}</button>)
        }
        else {
            return (<button
                disabled="disabled"
...
export default injectIntl(withRouter(CloseButton))
...
class DownloadButton extends React.Component {
    ...
    render() {
        var text = this.props.text || this.props.intl.formatMessage({ id: 'download' });
        ...
        if (this.props.enabled) {
            return (<button
                ...
                onClick={this.clickHandler}><FontAwesomeIcon icon={faDownload} /> {text}</button>)
        }
        else {
            return (<button
                disabled="disabled"
...
export default injectIntl(withRouter(DownloadButton))
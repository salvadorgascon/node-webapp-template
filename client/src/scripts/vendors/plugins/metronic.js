...
require('scripts/vendors/includes/metronic/vendors/plugins/select2.init.js');

// Flatpickr - is a lightweight and powerful datetime picker.
require('flatpickr/dist/flatpickr.min.js');
require('scripts/vendors/includes/metronic/vendors/plugins/flatpickr.init.js');
...
require('scripts/vendors/includes/metronic/vendors/plugins/dropzone.init.js');

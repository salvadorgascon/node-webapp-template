...
class OkButton extends React.Component {
    ...
    render() {
        var text = this.props.text || this.props.intl.formatMessage({ id: 'ok' });
        ...
        if (this.props.enabled) {
            return (<button
                ...
                onClick={this.clickHandler}><FontAwesomeIcon icon={faCheck} /> {text}</button>)
        }
        else {
            return (<button
                disabled="disabled"
...
export default injectIntl(withRouter(OkButton))
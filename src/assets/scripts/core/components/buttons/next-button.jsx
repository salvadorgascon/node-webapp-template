...
class NextButton extends React.Component {
    ...
    render() {
        var text = this.props.text || this.props.intl.formatMessage({ id: 'next' });
        ...
        if (this.props.enabled) {
            return (<button
                ...
                onClick={this.clickHandler}><FontAwesomeIcon icon={faArrowRight} /> {text}</button>)
        }
        else {
            return (<button
                disabled="disabled"
...
export default injectIntl(withRouter(NextButton))
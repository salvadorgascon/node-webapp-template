...
class PreviousButton extends React.Component {
    ...
    render() {
        var text = this.props.text || this.props.intl.formatMessage({ id: 'previous' });
        ...
        if (this.props.enabled) {
            return (<button
                ...
                onClick={this.clickHandler}><FontAwesomeIcon icon={faArrowLeft} /> {text}</button>)
        }
        else {
            return (<button
                disabled="disabled"
...
export default injectIntl(withRouter(PreviousButton))